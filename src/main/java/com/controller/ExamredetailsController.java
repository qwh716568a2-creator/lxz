...
//                            examredetailsEntity.setExamredetailsUuidNumber(data.get(0));                    //问卷编号 要改的
...
//                            examredetailsEntity.setExamredetailsMyanswer(data.get(0));                    //用户选项 要改的
//                            examredetailsEntity.setCreateTime(date);//时间
    ...
    */
    ...
    @IgnoreAuth
    @RequestMapping("/savePublicExamredetails")
    public R savePublicExamredetails(@RequestBody ExamredetailsEntity examredetails){
        if(StringUtil.isEmpty(examredetails.getExamredetailsUuidNumber()) || examredetails.getExamquestionId() == null){
            return R.error(511,"missing survey or question");
        }
        examredetails.setYonghuId(0);
        examredetailsService.delete(new EntityWrapper<ExamredetailsEntity>()
                .eq("examredetails_uuid_number", examredetails.getExamredetailsUuidNumber())
                .eq("yonghu_id", 0)
                .eq("examquestion_id", examredetails.getExamquestionId()));
        examredetails.setCreateTime(new Date());
    ...
    @IgnoreAuth
    @RequestMapping("/addPublicUnsaved")
    public R addPublicUnsaved(@RequestParam Map<String, String> params){
